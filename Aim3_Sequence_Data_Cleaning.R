...
write.table(new_data_decontaminated001,"MinusNegsBlanks_001.txt", sep="\t") ### This became tab "Filtered-BlankNegbyCode" in "ExtractionBatch0001_PCR102NC.xlsx". 
...
write.csv(all_complete_decontaminated,"all_Decontaminated_byBlankandNegs_complete.csv")
...
otu.data <- read.csv('all_toFilt_10_percent.csv', row.names = 1,as.is = T)
