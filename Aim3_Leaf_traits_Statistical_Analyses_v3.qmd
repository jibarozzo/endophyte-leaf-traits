...
suppfig7_pairwise_t_test <- master |>
  group_by(Species) |>
  pairwise_t_test(Pathogen_percent_damage ~ E_load,
         p.adjust.method = "BH",
  paired = TRUE,
  #var.equal = F,
  alternative = "two.sided",
...
#ggsave(filename = "./plots/Aim3_FigS7_21JAN024.jpg", plot = ant_arranged_with_caption, dpi=600, units=c("mm"), width=180, height=140, bg = "white")
...
suppfig_S8
#Saving
#ggsave(filename ="./plots/Aim3_FigS8_21JAN2024.jpg", plot = arranged_with_caption, dpi= 600, units=c("mm"), width=180, height=140, bg = "white")
