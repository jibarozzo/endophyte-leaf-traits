...
renv::install("nlme")
renv::install("MASS")
renv::install("car") #For type 3 Anova with Anova() function.
renv::install("PerformanceAnalytics")
renv::install("corrr")
renv::install("permute")
renv::install("lattice")
renv::install("pls")
renv::install("buildmer")
renv::install("lme4")
renv::install("sjPlot")
renv::install("glmmTMB")
renv::install("indicspecies")

# Phylogenetic analyses #source("https://raw.githubusercontent.com/joey711/phyloseq/master/inst/scripts/installer.R",local = TRUE)
renv::install("mgcv")
renv::install("phyloseq")
renv::install("ape")
library("metagMisc")
remotes::install_github("vmikk/metagMisc")
#renv::install("speedyseq")
renv::install("picante")
