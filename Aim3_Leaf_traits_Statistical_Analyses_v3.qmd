...
Somewhat better distributions. Ant_percent_leafloss is not normally distributed. It looks more like a binomial distribution. Evaluate accordingly. Conclusion from the Shapiro-Wilk tests: Some of the independent variables are not normally distributed. \## Variance Inflation Factor on simple LM with Toughness and Thickness
...
### Conclusions of pathogen model selection with raw functional leaf traits
