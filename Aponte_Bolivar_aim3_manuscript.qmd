...
table1_ggplot <- data %>%
  ...
  tab_footnote(
    footnote = "Outliers have been removed to better visualize distribution of LFT values.",
...
# gtsave(table1_ggplot, "tables/table1_ggplot.html")
...
table2 <- huxreg(
  ...
  insert_row("Fixed effects", "", "", "", "", after = 2, copy_cell_props = FALSE) |>
...
#| warning: false
#| label: tbl-linearreg
#| tbl-cap: "Summary of simple linear regression models for predicting leaf herbivory and pathogen damage"
...
regrex_all %>%
  gt(groupname_col = "type_damage", row_group_as_column = TRUE) %>%
