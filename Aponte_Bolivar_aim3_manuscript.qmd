...
#| fig.width: 6.5
#| fig.height: 6
#| fig.cap: "FEF community composition was associated with leaf functional traits (LFTs) from the leaf economic spectrum (LES) (genomic data set). Variation in FEF community composition within and between host species (*n* = 7) and treatment groups (*E*-, *E*+) from distance-based redundancy analyses (dbRDA). Solid black arrows represent statistically significant associations (*p* <.01). The arrows are displayed at double their actual size to enhance visual clarity. Each point represents a FEF community sample from one host tree species per treatment group; colors represent host tree species. Circles and filled triangles represent low (*E*-) and high (*E*+) FEF treatment groups, respectively."
...
table4 <- regrex_all |>
  ...
  tab_header(
    title = md("**Table 3: Summary of simple linear regression models for predicting leaf herbivory and pathogen damage**")
  ) |>
  tab_footnote(
