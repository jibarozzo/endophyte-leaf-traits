...
regrex_ehigh <- data.table(
  ...
  Treatment = "E-high",
  Leaf_damage = c("Herbivory (%)", "Pathogen Damage (%)"),
  "R^2^~adj~" = c(
...
# All observations
regrex_all <- rbind(regrex_ehigh, regrex_elow)
