...
#ggsave(filename="./Plots/Aim3_PatPC1_08282023.png", plot = pat_pc1, dpi=600, units=c("mm"), width = 180, height = 180, bg = "white")
...
pat_pc2 <- ggplot(pat_pcalm, aes(PC2, Pathogen_percent_damage)) +
  ...
  scale_color_manual(values = met.brewer(name = "Cross", n = 8, type="discrete")) +
  theme_minimal(base_size = 12) +
  labs(title = "Pathogen damage vs. PC2", y = "Pathogen damage (%)", caption = "") +
  theme(plot.title = element_text(color="red", size = 14, face="bold.italic")) +
...
#ggsave(filename="./Plots/Aim3_PatPC2_08282023.png", plot = pat_pc2, dpi=600, units=c("mm"), width = 180, height = 180, bg = "white")
```
