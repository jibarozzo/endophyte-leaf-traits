...
# GLM tables with `sjPlot` package
...
# GLM tables with `flextable` package
# Checking AIC values
broom.mixed::glance(M3REM, conf.int = TRUE, effects = "fixed") 

# Herbivory model
# `flextable` uses `broom.mixed::tidy` to extract model coefficients. The same could be achieved with `broom::tidy` for `lme` models and changing the `effects` argument to "var_model" then "ran_pars" instead of "fixed".
broom::tidy(M3REM,
     scales = "sdcor",
     conf.int = TRUE,
     conf.level = 0.95,
...
herb_model_table <- flextable::as_flextable(M3REM, add.random = TRUE, 
                        show.signif.stars = FALSE) |>
  # flextable::set_caption(
  #   as_paragraph(
  #     as_b(
  #       as_chunk("Table 3: Linear mixed effects models for predicting leaf herbivory and pathogenicity",
  #                props = fp_text_default(font.family = "Tex Gyre Termes", font.size = 12)
  #              )
  #     )
  #   ),
  ...
  flextable::add_header_lines(
      as_paragraph(
        as_chunk("Herbivory model",
                 props = fp_text_default(font.family = "Tex Gyre Termes",
                                         bold = TRUE,
                                         font.size = 12)
              )
      )
  ...
  set_header_labels(group = "Predictors") |>
  flextable::align(j = 1, align = "left", part = "body") |>
  flextable::align(j = 2:8, align = "center", part = "all") |>
  flextable::italic(j = c(3:8), italic = TRUE, part = "header") |>
  flextable::italic(i = c(1,6), j = 1, italic = TRUE, part = "body") |>
  flextable::bold(i = 2, bold = TRUE, part = "header") |>
  flextable::bold(i = c(3:5), j = c(7:8), bold = TRUE, part = "body") |>
  delete_rows(i = c(9:16) , part = "body") |>
  hline_bottom(j = c(1:8), 
...
patho_model_table <- flextable::as_flextable(P3REM, add.random = TRUE, 
                        show.signif.stars = FALSE) |>
  flextable::add_header_lines(
      as_paragraph(
        as_chunk("Pathogen damage model",
                 props = fp_text_default(font.family = "Tex Gyre Termes",
                                         bold = TRUE,
                                         font.size = 12)
              )
  ...
  flextable::bold(i = 2, bold = TRUE, part = "header") |>
  flextable::bold(i = c(3:5), j = c(7:8), bold = TRUE, part = "body") |>
  delete_rows(i = c(5:12) , part = "body") |>
  hline_bottom(j = c(1:8), 
               border = fp_border(color = "black", 
                                  style = "solid", 
                                  width = 1.25), 
...
# save_as_docx(
#   `table3_herbivory` = herb_model_table, `table3_pathogen` = path_model_table,
#   path = tf, pr_section = sect_properties
# )
# save_as_docx(herb_model_table, path = "./tables/table3_herbivory.docx")
#   
```
