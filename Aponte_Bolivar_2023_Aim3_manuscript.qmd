...
*We hypothesized that FEF improve leaf defenses against generalist herbivores and pathogens, especially in plants that invest less in constitutive defenses (e.g., thin leaves and short-lived). Alternatively, plants that invest more in constitutive defenses rely less on induced FEF acquisition. To test our hypothesis we designed an experiment that manipulated tropical tree seedlings and measured leaf damage (herbivory and pathogen infection) and a subset of leaf functional traits: leaf mass per area (LMA) , leaf thickness (LT), leaf punch strength (LPS), and anthocyanins (ACI), in response to high and low FEF density treatments.*
*We predicted the following:* 
1) Leaf-cutter ants and Calonectria sp. would cause less leaf damage (herbivory through leaf tissue removal and leaf necrosis through pathogen infection, respectively) on leaves with higher FEF abundance, richness and diversity composition; 

2) Tree species with leaf functional traits on the low end of the economic spectrum (e.g., lower leaf mass per area) would have less herbivory and pathogen damage when treated with high FEF densities compared to their low FEF density counterparts; 

3) Conversely, tree species with leaf functional traits of the high side of the economic spectrum (e.g., greater leaf mass per area) treated with high FEF density would have no differences in herbivory and pathogen damage compared to their low FEF counterparts; 

4) We anticipated that leaves with leaf functional traits on the high end of the economic spectrum would be less attractive to leaf-cutter ants, but *E-* in them may outweigh this selection factor. To test our predictions, we addressed the following questions:*
...
Our results support the hypothesis that FEF communities improve leaf defenses against a generalist herbivore and pathogen. We see that the *E+* treatment group had significantly less herbivory damage than the *E-* treatment group when considering all tree species (Figure 2). On a species level, we did not see significant differences between treatment groups (Figure S6a). This is probably due to a small replicate size in treated individuals per species used in herbivory assay trials (see Replication Statement), but we do see that the high FEF group has lower herbivory damage in all tree species (Figure S6a). We did not observe the same pattern the pathogen damage, where we did not see significant differences between treatment groups when considering all tree species (Figure 2b). Similar to the response to herbivory damage, treatment groups per species did not have significant differences in pathogen damage. Interestingly we see that the *E+* group has equal of slightly higher pathogen damage than the *E-* group in all tree species (Figure S6b). The FEF diversity and community composition did influence herbivory damage, we see reduced herbivory as Shannon diversity index increases (Figure S7e). Unexpectedly, we see an inverse relationship between the treatment groups. The *E+* group experienced higher herbivory damage as Shannon diversity increased, while the opposite is true for the *E-* group (Figure S7e). We interpret this as a threshold were the acquisition of more FEF increases the chances of hosting a species that is more attractive to leaf-cutter ants. it is interesting because it highlights a tipping point in the presumably asymptomatic symbioses host species have with FEF communities. On the other hand, we see a significant increase in pathogen damage as Shannon diversity index increased for the complete data set (Figure S8e). Pathogen damage significantly increased in the *E+* group as Shannon diversity increased, but the *E-* group did not (Figure S8e). Regardless of significance, it is a positive trend which might signal a similar tipping point mechanism as in the herbivory assays. In this case, the FEF abundance and diversity potentially has a synergistic interaction with *Calonectria* sp., ultimately increasing pathogen damage intensity.  
The lens we are using to interpret theses results relies on the leaf economic spectrum (LES) where leaves with leaf functional traits with high values tend to be long-lived leaves and the opposite [@wright, @kitajima2013, @poorter2006]. The LES spectrum in turn acts as a host imposed filter which FEF communities have to overcome to colonize leaf tissue, assemble, and carry out their life cycle. We did not measure leaf lifespan directly, but we can use the values obtained for the leaf functional traits we measured as proxies for leaf lifespan, with the caveat that the traits were measured on seedlings and leaves were relatively young (< 150 days). We see that species with relatively low values of ACI, LT, and LPS (Figures S2 - S5) constrained in PC1 axis (Figure 4b) experienced very little herbivory damage (i.e., *Dypteryx* sp.) or had much variability (i.e., *C. alliodora*) (Figure 5a). Species with relatively high values of ACI, LT and LPs like *C. cainito* experienced low to moderate herbivory damage (Figure 5a). A similar pattern arises with the pathogen damage data set (Figure 5c). The contrast in the slopes of the regression lines in Figure 5a and 5c highlight the potential importance LES traits have to counter herbivory and pathogen damage. We interpret these findings and and those presented in Figure S7 as support for our prediction, where leaves on the high end of the LES, are less attractive to leaf cutter-ants but the effects of FEF communities out weigh this selection factor after a tipping point is reached, where everything leaf is equally likely of being infected and acquiring resources (leaf cuttings) is the only limiting factor. 
