...
#| fig.height: 5
#| fig.width: 7
#| fig.cap: "Figure S2: (a) Comparison of leaf thickness (LT) between *E-* and *E+* treatment groups. (b) Comparison of LT *E-* and *E+* treatment groups per species. Significance levels are represented by asterisks [*p* = 0.05 (\\*), *p* = 0.01 (\\**), and *p* = 0.001 (\\***)]."
...
#| fig.height: 5
#| fig.width: 7
#| fig.cap: "Figure S3: (a) Comparison of leaf punch strength (LPS) between *E-* and *E+* treatment groups. (b) Comparison of LPS between *E-* and *E+* treatment groups per species. Significance levels are represented by asterisks [*p* = 0.05 (\\*), *p* = 0.01 (\\**), and *p* = 0.001 (\\***)]."
#| 
# Figure S3
