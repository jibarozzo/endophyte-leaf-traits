...
Simple linear regressions of herbivory (%) against PC1 revealed no correlation (*F*-statistic = 0.508, *df* = 208, R^2^~adj~ = -0.0024, *p* = 0.447)(Fig. 5a), where positive values represent greater values of ACI, LPS and LMA. Even though we note large spread in the data (Fig. 5a and 5b), we see a statistically significant positive trend of herbivory plotted against PC2 (*F*-statistic = 18.9, *df* = 208, R^2^~adj~ = 0.079, *p* \< 0.0001), where positive values represent greater LT (Fig. 5b). Percent pathogen damage plotted against PC1 revealed a statistically significant significant correlation (*F*-statistic = 26.93, *df* = 380, R^2^~adj~ = 0.064, *p* \< 0.0001), in which positive values represent greater values of ACI, LPS and LMA (Fig. 5c). We did not see a statistically significant relationship between pathogen damage and PC2 (*F*-statistic = 1.60, *df* = 380, R^2^~adj~ = 0.002, *p* = 0.207) (Fig. 5d). We found similar patterns in the simple linear regressions performed on the leaf functional traits with out reducing dimensions and logit transformed herbivory and pathogen damage data (Fig. S7 and S8, respectively). We observed a statistically significant positive relationship between herbivory and LT (*F*-statistic = 19.45, *df* = 208, R^2^~adj~ = 0.081, *p* \< 0.0001) when considering the complete data set (Figure S7a). We did not observe statistically significant relationship between herbivory (%) and LPS, ACI, LMA, and Shannon's diversity index (Figure S7b - S7e) for the complete data set. However, we did observed a general decline in herbivory as FEF diversity increased which aligns our predictions. In further detail we see a statistically significant negative relationship between herbivory and Shannon diversity for the *E-* treatment group (*F*-statistic = 17.7, *df* = 103, R^2^~adj~ = 0.138, *p* \< 0.0001) (Figure S7e). We also see an in crease in herbivory for the *E+* treatment group as Shannon's diversity index increased, but this is not statistically significant ((*F*-statistic = 3.55, *df* = 103, R^2^~adj~ = 0.024, *p* = 0.062) (Figure S7e). For the simple linear regressions of pathogen damage against leaf functional traits we observed a statistically significant negative relationships between pathogen damage and LPS (*F*-statistic = 33.32, *df* = 380, R^2^~adj~ = 0.078, *p* \< 0.0001), ACI (*F*-statistic = 14.34, *df* = 380, R^2^~adj~ = 0.033, *p* = 0.0002) and LMA (*F*-statistic = 12.6, *df* = 380, R^2^~adj~ = 0.030, *p* \< 0.001) (Figure S8b - S8d) when considering the complete data set. Pathogen damage did not have a statitiscally siginificant correlation with LMA (*F*-statistic = 0.50, *df* = 380, R^2^~adj~ = -0.001, *p* = 0.482) (Figure S8a). The *E-* and *E+* treatment groups follow the same general trend as the complete data set. Contrary to our predictions, when we observe the complete data set find a statistically significant positive relationship between pathogen damage and Shannon's diversity index (*F*-statistic = 6.90, *df* = 380, R^2^~adj~ = 0.015, *p* \< 0.01) (Figure S8e). Upon further scrutiny, only the *E+* treatment group has a satistically significantly positive correlation between pathogen damage and Shannon's diversity index (*F*-statistic = 7.11, *df* = 188, R^2^~adj~ = 0.031, *p* \< 0.01) (Figure S8e).
