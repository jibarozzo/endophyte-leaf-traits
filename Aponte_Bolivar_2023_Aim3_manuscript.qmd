...
Simple linear regressions of herbivory (%) against PC1 and PC2 revealed a statistically significant positive relationship (*p* \<0.001) (Fig. 4a and 3b). Even though we note large spread in the data (Fig. 4a and 3b), we see a statistically significant positive trend of herbivory plotted against PC1, where positive values represent greater values of ACI, LPS and LMA. Herbivory plotted against PC2 shows a statistically significant positive trend, where positive values represent greater LT (Fig. 4b). Percent pathogen damage plotted against PC1 revealed a statistically significant positive relationship (*p* = \<0.001), in which positive values represent greater values of ACI, LPS and LMA (Fig. 4c). We did not see a statistically significant relationship (*p* = 0.223) between pathogen damage and PC2 (Fig. 4d).
...
#ggsave(filename="./plots/Aim3_Fig2_12JAN2024.png", plot=p_m3dbrda, dpi=600, units=c("mm"), width=200, height=200)
```
...
#ggsave(filename = "./plots/Aim3_Fig3_02JAN2024.png", plot = grid_pca, dpi=600, units=c("mm"), width = 275, height = 300, bg = "white")
...
figure4<- ggarrange(ant_pc1, ant_pc2, pat_pc1, pat_pc2,
                    nrow = 2, 
                    ncol=2, 
                    label.x = -0.015, vjust = 1, 
                    labels = c("(a)", "(b)", "(c)", "(d)"),
...
#ggsave(filename = "./plots/Aim3_Fig4_04JAN2024.png", plot = figure3, dpi=600, units=c("mm"), width = 300, height = 225, bg = "white")
...
suppfig_6
#ggsave(filename="./plots/Aim3_FigS6_15JAN2024.png", plot = suppfig_6, dpi=600, units=c("mm"), width = 250, height = 200, bg ="white")
```
...
suppfig_7
#ggsave(filename="./plots/Aim3_FigS7_15JAN2024.png", plot = suppfig_7, dpi=600, units=c("mm"), width = 250, height = 200, bg ="white")
```
