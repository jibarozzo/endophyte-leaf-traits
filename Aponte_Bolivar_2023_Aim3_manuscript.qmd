...
Vascular plants have encountered multiple biotic and abiotic selective pressures throughout their evolutionary history (CITE). As plants expanded inland they encountered new climates, substrates, and stressors. Plants have developed  and been successful with an array of strategies to combat enemies, especially those that damage their leaf tissue, from alkaloids and secondary metabolites (e.g. jasmonic acid) to structures that deter potential pests (e.g., thorns/modified leaves). Specific leaf functional traits such as shape, leaf thickness, leaf toughness, leaf mass per area (LMA), and anthocyanins are a plant’s first line of defense against herbivores and pathogens, key selective evolutionary pressures (CITE).

Leaf functional traits are expressed differentially across species and are influenced by their life history and the environment they occupy. The optimal defense theory (ODT) is useful to understand plants’ allocation of resources to leaf traits, more specifically to leaf defenses. Three main predictions stem from ODT [@stamp2003]. First, a plant’s investment in defenses is positively related to attack rate (e.g., herbivory rate or pathogen intensity) and inversely related to resource allocation or ecological costs (Holeski, Chase-Alone, & Kelly, 2010). Second, where the cost of defense is low, plants will allocate resources differentially to specific parts and tissues, resulting in greater investment in tissues with high fitness value (e.g., investment flower/seed production). Third, in response to attacks (stimuli), plants will increase their defenses (an induced plastic response). Broadly, ODT predicts that a plant’s capacity to increase induced defenses after an attack is negatively correlated to its constitutive defenses (e.g., leaf functional traits) [@holeski2010]. Leaf defenses fall within an economic spectrum of functional traits that, on one end has leaves with high nutrient content (e.g., nitrogen), low leaf mass per area (LMA), thin leaves blades and thin celled walls are associated with shorter leaf lifespans on the other end, leaves with low nutrient content, high LMA, thick leaf blades and cell walls associated with longer lifespans (e.g., non-N-fixing species) [@mason2015; @wright2004]. The investment in baseline constitutive defenses results in leaves with longer lifespans [@kitajima2012; kitajima2013]. Plants that invest little in leaf nutrient content and have low LMA are potentially more capable of having greater induced defense levels [@kitajima2013; @poorter2006; @wright2004]. Leaf functional traits, whether constitutive or induced, represent an environmental filter for associated leaf microbial communities that have been shown to contribute to leaf defenses (CITE Mejia and Van Bael cacao and cucumber papers).
Leaf microbial communities, especially foliar endophytic fungi (FEF), are found inside the leaf tissue of all vascular land plants (Currie et al., 2014; Rodriguez, White, Arnold, & Redman, 2009). They are generally asymptomatic but have been found to behave as pathogens under certain environmental conditions [Porras-Alfaro and Bayaman 2011]. Fungal endophytes are a unique study system to ask community ecology questions because they have a delimited area—the leaf—and are naturally replicated. Multiple leaves of the same plant or multiple individuals of the same species can be compared depending on the hypotheses being tested. In tropical forests, FEF transmit horizontally through ambient spore fall [@arnold2000]. Newly flushed leaves are free of FEF presenting fungal spores with challenges to colonization that will ultimately determine FEF communities.

 a growing understanding of trade-offs in defenses
themselves (e.g., as a function of antagonism in the jasmonic acid/salicylic acid pathways, relevant to
defenses against herbivores and pathogens; Thaler et al. 1999, Felton & Korth 2000, Caarls et al. 2015)
provide a context for understanding differential impacts of endophytes on anti-herbivore and anti-
pathogen defenses, as yet an open question.
...
If FEF improves leaf defenses against plant pests, then generalist herbivores and pathogens will remove or damage less leaf tissue from plants with treated high FEF levels relative to those with low FEF loads.

### Predictions

Leaf-cutter ants will remove less plant material from leaves with higher FEF abundance and richness, but this result will be modulated by leaf traits related to defenses. Leaves with longer lifespans will be less attractive to leaf-cutter ants. Alternatively, low FEF diversity in those leaves may outweigh this selection factor. Leaves treated with high FEF levels will have a smaller area of pathogen damage compared to those treated with low FEF levels. FEF-mediated defenses against pathogens will be most important in short-lived leaves since long-lived leaves are expected to rely more on constitutive defenses (e.g., leaf toughness).
